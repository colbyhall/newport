use super::Device;
use crate::{
    BlendFactor, BlendOp, ColorMask, CullMode, DrawMode, PipelineDescription, ShaderVariant,
    VertexAttribute,
};
            ...
            PipelineDescription::Graphics(desc) => {
                ...
                fn blend_factor(fc: BlendFactor) -> vk::BlendFactor {
                    match fc {
                        ...
                        BlendFactor::OneMinusSrcColor => {
                            return vk::BlendFactor::ONE_MINUS_SRC_COLOR
                        }
                        BlendFactor::DstColor => return vk::BlendFactor::DST_COLOR,
                        BlendFactor::OneMinusDstColor => {
                            return vk::BlendFactor::ONE_MINUS_DST_COLOR
                        }
                        BlendFactor::SrcAlpha => return vk::BlendFactor::SRC_ALPHA,
                        BlendFactor::OneMinusSrcAlpha => {
                            return vk::BlendFactor::ONE_MINUS_SRC_ALPHA
                        }
                    }
                }
                ...
                if desc.push_constant_size > 0 {
                    pipeline_layout_info =
                        pipeline_layout_info.push_constant_ranges(from_ref(&range));
                }
