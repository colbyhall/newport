...
use newport_editor::{Direction, Editor, View};

mod details;
mod outliner;
mod viewport;

pub use {details::*, outliner::*, viewport::*};
...
impl Module for GameEditor {
    fn new() -> Self {
        ...
        let details_and_outliner = View::new_views(
            "details_and_outliner",
            0.2,
            vec![details_view, outliner_view],
            Direction::DownToUp,
        );
        ...
        let view = View::new_views(
            "main",
            1.0,
            vec![details_and_outliner, level],
